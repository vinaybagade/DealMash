...
public class UserDashboard extends ActionBarActivity
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        switch (position){
            case 0:
                ...
                break;
            case 1:
                mTitle = "Edit Preferences";
                fragmentManager.beginTransaction()
                        .replace(R.id.container,EditPreferences.newInstance())
                        .commit();
                getSupportActionBar().setTitle(mTitle);
                break;
            case 2:
            ...
            case 4:
                mTitle="Logout";
                fragmentManager.beginTransaction()
                        .replace(R.id.container,Logout_Fragment.newInstance())
                        .commit();
                getSupportActionBar().setTitle(mTitle);
                break;
        }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onAttach(Activity activity) {
            ...
            ((UserDashboard) activity).onSectionAttached(
